...
const Footer = () => {
  ...
  return (
    <footer className="mt-8 flex w-full flex-col items-center justify-center gap-3 border-t border-white/30 bg-white/80 p-4 shadow-inner backdrop-blur-md sm:flex-row sm:gap-8">
      <button
        onClick={() => router.push('/')}
